...
# routers IA
from healthai.api.routers import profiles, meals, recommendations, posts, media, social_users
...
from healthai.models.social import Post, Comment, PostLike, SocialUser
...
app.include_router(social_users.router)
